function feedback() {
    let feedbackControls = document.querySelectorAll(".change-form");
    feedbackControls.forEach(feedbackControl => {
        let btns = feedbackControl.querySelectorAll(".change-form__title");
        let blocks = document.querySelectorAll(".tab-feedback");
        let secondForm = document.querySelector(".form-feedback_second");
        let line = feedbackControl.querySelector(".change-form__line");
        let gap = 20;
